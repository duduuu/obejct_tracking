...
custom_hooks = [
    dict(
        ...
        init_kwargs=dict(
            ...
            name=
            './mmtracking/configs/mot/bytetrack/bytetrack_yolox_x_8xb4-80e_maicon-ir-cocovidhalftrain_test-mot17halfval.py_11_30-15_07_10',
            save_code=True,
            ...
            config=dict(
                ...
                test_pipeline=[
                    dict(type='LoadImageFromFile'),
                    dict(
                        type='mmdet.Resize', scale=(540, 960),
                        keep_ratio=True),
                    dict(
                        type='mmdet.Pad',
                        size_divisor=32,
                ...
                model=dict(
                    ...
                    tracker=dict(
                        ...
                        num_frames_retain=30)),
                train_cfg=dict(
                    type='EpochBasedTrainLoop', max_epochs=80, val_interval=1),
                val_cfg=dict(type='ValLoop'),
                test_cfg=dict(type='TestLoop'),
                param_scheduler=[
                    dict(
            ...
            tags=[
                'CocoVideoDataset', '/workspace/data/01_data', 'ByteTrack',
                'CSPDarknet', 80, 'SGD'
            ],
            id='d03daf28-18b3-4b94-869f-c47f17c6d3a1'),
        interval=10,
        log_checkpoint=True,
